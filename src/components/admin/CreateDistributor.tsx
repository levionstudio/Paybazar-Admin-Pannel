...
const CreateDistributorPage = () => {
  ...
  const onSubmit = async (data: DistributorFormData) => {
    ...
    const requestPayload = {
      ...
      distributor_aadhar_number: data.aadhar,
      distributor_pan_number: data.pan,
      distributor_date_of_birth: data.dob,
      distributor_gender: data.gender,
      distributor_city: data.city,
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="city" placeholder="Chennai" {...register("city")} className="h-11" />
                {errors.city && (
              ...
              <div className="space-y-2">
                ...
                <Input id="state" placeholder="Tamil Nadu" {...register("state")} className="h-11" />
                {errors.state && (
